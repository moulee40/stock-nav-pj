    ...
    return (
      <div className="flex ml-2 flex-grow w-2/6">
        ...
        {display && stockTrendDisplay && (
          <div className="flex flex-col justify-center mt-10 space-y-2 w-2/4">
            <StockTrendChart onBackChange={onBackChange} fiftyDaysAverage={fiftyDaysAverage} 
            twoHundredDaysAverage={twoHundredDaysAverage} data={stockTrendData} />
          </div>
        )}
        {display && stockPriceComparisonDisplay && (
          <div className="flex flex-col justify-center mt-10 space-y-2 w-2/4">
            <StockPriceComparisonChart onBackChange={onBackChange} data1={stockSymbolData1} data2={stockSymbolData2}/>
          </div>
        )}
      </div>
    );
